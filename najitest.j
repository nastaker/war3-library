library najitest initializer OnInit
globals
...
function TestA22_naji takes nothing returns nothing
    ...
    if u_naji!=null then
        ...
        call DisplayTimedTextToPlayer(GetTriggerPlayer(),0,0,60,"|cffFF80C0种族：|cffFFFF00"+Sdummy_naji[0]+"|r")
...
function TestA19_naji takes nothing returns nothing
    ...
    if GetTriggerPlayer()==null then
        call DisplayTextToPlayer(Ptest_naji,0,0,Sdummy_naji[3]+"|cffFFFF00"+GetUnitName(GetTriggerUnit())+"|cffFF0000"+ID2S_naji(GetUnitTypeId(GetTriggerUnit()))+"|cffFFFF00"+Sdummy_naji[1]+"|cffFF80C0第一次进入地图|r")
    else
        if Bpn_naji then
...
function TestA_naji takes nothing returns nothing
    ...
    call QuestSetDescription(Q_naji[2],"|cffFFFF00'naji|cffFF0000(|rnajitest system|cffFF0000)|r|cffFFFF00'gms|cffFF0000(|r(Group Multiple Spell)|cffFF0000)|r|cffFFFF00'gcd|cffFF0000(|r(Group Cool Down)|cffFF0000)|r|n|n|cff00FFFF该系统包含众多测试功能，输入后会打开一个对话框")
    ...
    //=========================naji system开始==============================
        //'naji(najitest system)
    set Dnaji_naji[0]=DialogCreate()
    call TriggerRegisterPlayerChatEvent(Ttest_naji[1],GetTriggerPlayer(),"'naji",true)
...
function OnInit takes nothing returns nothing
  ...
  local integer i_naji=0
  loop
      call TriggerRegisterPlayerChatEvent(t_naji,Player(i_naji),"'naji",true)
      set i_naji=i_naji+1
      exitwhen i_naji>=12
  endloop
